...
/**
 * Test class for model object {@link ConfirmProcedure}.
 *
 * @author johannes
 */
public class ConfirmProcedureTest {
  /**
   * Test method for hashCode and equals methods of {@link ConfirmProcedure}. This test checks if any change of parameters has an
  ...
  public void testHashCodeAndEquals() {
    ...
    ConfirmProcedure a = ConfirmProcedure.getInstance(0L);
    ConfirmProcedure b = ConfirmProcedure.getInstance(0L);
    a.setEndDate(temp);
    b.setEndDate(temp);
