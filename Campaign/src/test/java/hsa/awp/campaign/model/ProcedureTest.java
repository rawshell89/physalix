...
/**
 * Test class for model object {@link Procedure}.
 *
 * @author johannes
 */
public class ProcedureTest {
  /**
   * Test method for hashCode and equals methods of {@link Procedure}. This test checks if any change of parameters has an effect
  ...
  public void testHashCodeAndEquals() {
    ...
    Procedure a = Procedure.getInstance(0L);
    Procedure b = Procedure.getInstance(0L);
